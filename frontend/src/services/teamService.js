...
export const getPlayersByTeam = async (id) => {
    const res = await api.get(`/save-game-teams/${id}/players`);
    return res.data;
};
/**
...
export const getTeamFinances = async (id) => {
    const res = await api.get(`/save-game-teams/${id}/finances`);
    return res.data;
};
/**
...
export const getOpponentInfo = async (id) => {
    const res = await api.get(`/save-game-teams/${id}/opponent`);
    return res.data;
};
