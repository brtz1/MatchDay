...
export var DivisionTier;
(function (DivisionTier) {
    DivisionTier[DivisionTier["DIVISION_1"] = 1] = "DIVISION_1";
    DivisionTier[DivisionTier["DIVISION_2"] = 2] = "DIVISION_2";
    DivisionTier[DivisionTier["DIVISION_3"] = 3] = "DIVISION_3";
    DivisionTier[DivisionTier["DIVISION_4"] = 4] = "DIVISION_4";
